...
test.describe('Reality Explorer', () => {
  ...
  test('00 - Test Signup Flow', async () => {
    ...
    if (signupButton) {
      ...
      if (emailField) await emailField.fill(\`test-\${Date.now()}@guardrail.dev\`);
  ...
  test('01 - Test Login Flow', async () => {
    ...
    if (loginButton) {
      ...
      if (emailField) await emailField.fill('test@guardrail.dev');
      if (passwordField) await passwordField.fill('TestPass123!');
...
<body>
  <div class="container">
    ...
    <div class="footer">
      Generated by guardrail Reality Mode • <a href="https://guardrail.dev" style="color:#3b82f6">guardrail.dev</a>
    </div>
  </div>
</body>
</html>`;
...
function generateSARIF(results, targetUrl) {
  ...
  const ruleDefinitions = {
    "route-error": {
      ...
      helpUri: "https://guardrail.dev/docs/reality-mode#routes",
    },
    "element-error": {
      ...
      helpUri: "https://guardrail.dev/docs/reality-mode#elements",
    },
    "form-error": {
      ...
      defaultConfiguration: { level: "warning" },
      helpUri: "https://guardrail.dev/docs/reality-mode#forms",
    },
    "console-error": {
      ...
      defaultConfiguration: { level: "error" },
      helpUri: "https://guardrail.dev/docs/reality-mode#errors",
    },
    "uncaught-error": {
    ...
    runs: [
      {
        tool: {
          driver: {
            ...
            version: "2.0.0",
            informationUri: "https://guardrail.dev/reality-mode",
            rules,
          },
        },
        results: sarfResults,
