...
# Sessions analyzed: 19 | Strategies: 3
...
- **overengineering** (87% likely, ~10 wasted steps): Creating 3+ new files for what should be a localized change
...
> Your cognitive fingerprint across 19 sessions:
...
- Clean execution: 32% of sessions resolve with zero backtracks and ≤10 tool calls
...
**[95% ◆]** (90 sessions) — 61% predicted relevance
