...
- **scope-creep** (87% likely, ~15 wasted steps): Touching more than 10 files or exceeding 25 tool calls
  Prevention: Before expanding scope, ask: "Is this necessary for the SPECIFIC task requested?"
- **overengineering** (57% likely, ~10 wasted steps): Creating 3+ new files for what should be a localized change
