...
// App URL from environment (defaults to guardrailai.dev)
const APP_BASE_URL = process.env.APP_BASE_URL || "https://guardrailai.dev";
...
export class AutopilotService {
  ...
  private generatePRDescription(problems: Problem[]): string {
    ...
    description += `---\n`;
    description += `*Generated by [guardrail](https://guardrailai.dev) - Ship with confidence*`;
