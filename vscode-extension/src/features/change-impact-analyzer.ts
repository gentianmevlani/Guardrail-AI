...
<body class="ka-dashboard-body ka-panel-page">
  ...
  <div class="cia-topology-strip" aria-hidden="true">
    <svg viewBox="0 0 800 56" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="ciaEdge" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style="stop-color:#00e5ff;stop-opacity:0.15" />
          <stop offset="50%" style="stop-color:#00e5ff;stop-opacity:0.7" />
          <stop offset="100%" style="stop-color:#00e5ff;stop-opacity:0.15" />
        </linearGradient>
      </defs>
      <path d="M0 36 Q 200 8 400 36 T 800 36" fill="none" stroke="url(#ciaEdge)" stroke-width="1.5" />
      <circle cx="120" cy="28" r="4" fill="#00e5ff" opacity="0.9" />
      <circle cx="400" cy="36" r="5" fill="#00e5ff" />
      <circle cx="680" cy="30" r="4" fill="#00e5ff" opacity="0.85" />
      <line x1="120" y1="28" x2="400" y2="36" stroke="rgba(0,229,255,0.25)" stroke-width="1" />
      <line x1="400" y1="36" x2="680" y2="30" stroke="rgba(0,229,255,0.25)" stroke-width="1" />
    </svg>
  </div>
