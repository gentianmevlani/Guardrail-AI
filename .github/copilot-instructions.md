# GitHub Copilot Instructions - Guardrail-Ofiicial-main
...
> Master Flow Orchestrator + Guardrail Expert + Guiding Facilitator
...
1. Read the relevant truthpack file(s) from `.guardrail/truthpack/`
...
- Run `guardrail truthpack` to regenerate if you believe it is outdated
