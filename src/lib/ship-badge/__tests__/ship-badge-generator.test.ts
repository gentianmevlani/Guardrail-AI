  ...
  describe('generateReport', () => {
    it('should generate readable report for passing project', () => {
      const mockResult = {
        ...
        score: 100,
        checks: [
          { id: 'no-mock-data', name: 'No Mock Data', shortName: 'Mock', status: 'pass' as const, message: 'Clean' },
          { id: 'no-localhost', name: 'No Localhost', shortName: 'URLs', status: 'pass' as const, message: 'Clean' },
        ],
        badges: {
          main: '<svg>...</svg>',
          mockData: '<svg>...</svg>',
    ...
    it('should generate readable report for failing project', () => {
      const mockResult = {
        ...
        score: 33,
        checks: [
          { id: 'no-mock-data', name: 'No Mock Data', shortName: 'Mock', status: 'fail' as const, message: 'Found 5 issues', details: ['file1.ts', 'file2.ts'] },
          { id: 'no-localhost', name: 'No Localhost', shortName: 'URLs', status: 'pass' as const, message: 'Clean' },
          { id: 'env-vars', name: 'Env Vars', shortName: 'Env', status: 'fail' as const, message: 'Missing vars' },
        ],
        badges: {
          main: '<svg>...</svg>',
          mockData: '<svg>...</svg>',
