...
const RULE_DEFINITIONS: Record<string, Omit<SarifRule, 'id'>> = {
  'fake-api-domain': {
    ...
    helpUri: 'https://guardrail.dev/rules/fake-api-domain',
  ...
  'demo-response-data': {
    ...
    helpUri: 'https://guardrail.dev/rules/demo-response-data',
    defaultConfiguration: { level: 'error' },
  ...
  'mock-import': {
    ...
    helpUri: 'https://guardrail.dev/rules/mock-import',
    defaultConfiguration: { level: 'error' },
  ...
  'test-api-keys': {
    ...
    helpUri: 'https://guardrail.dev/rules/test-api-keys',
    defaultConfiguration: { level: 'error' },
  ...
  'simulated-billing': {
    ...
    helpUri: 'https://guardrail.dev/rules/simulated-billing',
    defaultConfiguration: { level: 'error' },
  ...
  'localhost-url': {
    ...
    helpUri: 'https://guardrail.dev/rules/localhost-url',
    defaultConfiguration: { level: 'error' },
  ...
  'banned-pattern': {
    ...
    helpUri: 'https://guardrail.dev/rules/banned-pattern',
    defaultConfiguration: { level: 'error' },
  ...
  'silent-fallback': {
    ...
    helpUri: 'https://guardrail.dev/rules/silent-fallback',
